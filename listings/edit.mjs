...
export function loadEditListingPage() {
  ...
  if (!token || !user) {
    page.innerHTML = `
      <section class="container edit-listing-message">
        <h1 class="page-title">Edit Listing</h1>
        <p>You need to be logged in to edit a listing.</p>
  ...
  async function loadListingToEdit() {
    try {
      ...
      const tagsValue = (listing.tags || [])
        .filter((tag) => tag !== "artevia")
        .join(", ");

      //format endsAt for datetime-local//
      const endsLocal = listing.endsAt
      ...
      page.innerHTML = `
        <section class="create-listing container">
          ...
          <form id="editListingForm" class="create-listing-form">
            <div class="form-grid">
              ...
              <div class="form-block form-block--full">
                ...
                <input 
                  ...
                  value="${tagsValue}" 
                />
                <p class="field-hint">We automatically add the <strong>artevia</strong> tag for you.</p>
              </div>
            </div>

            <div class="form-actions">
              <button type="submit" class="btn btn--primary">Update Listing</button>
              <button type="button" id="deleteListingBtn" class="btn btn--danger">Delete Listing</button>
